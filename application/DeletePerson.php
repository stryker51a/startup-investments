...
if (isset($_POST['field_submit'])) {
    ...
    $query = "CALL deletePerson(:ph_first, :ph_last, :ph_company)";
...
<html>
  ...
  <body>
    ...
    <h1> Delete a Person From the Database </h1>
    ...
    <div class = "container">
      <form method="post">
        ...
        <div class = "row">
          <div class="col-25">
            <label for="id_company">Name of Company:</label>
          </div>
          <!-- The input type is a text field. Note the name and id. The name attribute
          is referred above on line 7. $var_title = $_POST['field_title']; -->
          <div class="col-75">
            <input type="text" name="field_company" id= "id_company" placeholder="Can Be Empty">
          </div>
        </div>
    ...
    ?>
          <h3> Sorry, there was an error. The Person was not deleted or does not exist. </h3>
    <?php 
        }
      } 
    ?>
